...
import Data.Qualified (OptionallyQualified, Qualified, unqualified)
...
joinConversation zusr zcon = \case
  Left cnv -> joinLocalConversation zusr zcon cnv
  Right qcnv -> joinRemoteConversation zusr zcon qcnv
